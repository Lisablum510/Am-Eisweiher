...
const story = {
  ...
  kleinerTrakt: {
    ...
    grosserTrakt: {
      id: "grosserTrakt",
      text: ["Du kommst im grossen Trakt an und freust dich auf den Mathematik-Unterricht im 6. Stock.",
        "Vielleicht findest du ja dort jemanden, der auch Lust hat, eine Jazz-Band zu gründen.",
        "Am Besten fragst du mal deine Methelehrperson, ob sie jemanden kennt.",
        "Du bist allerdings etwas zurückhaltend und weisst nicht genau was du machen sollst."],
      image: "img/grosserTrakt.jpg",
      hasTimer: true,
      next: [
        { key: "bandGruenden", label: "Mathelehrperson fragen" },
        { key: "logarithmusGleichungen", label: "Logarithmus-Gleichungen lösen" },
        { key: "brawlStarsSpielen", label:"brawlStars"}
      ]
    },
...
startButton.addEventListener("click", function(){
    ...
    console.log("Start Button CLick wurde ausgeführt")
